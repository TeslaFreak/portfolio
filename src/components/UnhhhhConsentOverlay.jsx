...
const ConsentOverlay = ({ setHasConsent, setAutoPlay, isMobile }) => {
  const handleConsent = () => {
    setHasConsent(true);
    setAutoPlay(true);
  };
      ...
      <div className="flex flex-col items-center p-4 bg-gray-800 w-full">
        {!isMobile ? (
          <div className="text-white text-xl mb-4 text-center">
            ...
            consent before we play anything for you. Alternatively, just click
            any text bubble to play them individually!
          </div>
        ) : (
          <div className="text-white text-xl mb-4 text-center">
      ...
      {!isMobile && (
        <div className="absolute bottom-16 right-4 p-4 bg-gray-800 rounded-md w-80 items-end flex flex-col">
          <div className="text-white text-sm text-center">
            ...
            back on at any time to listen to the full conversation from any
            point you choose.
          </div>
